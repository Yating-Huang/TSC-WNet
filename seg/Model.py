...
class ResNetC1(nn.Module):
    ...
    def __init__(self, classes):
        ...
        self.p01 = PSPDec(16 + classes, classes, 160, 112)
        self.p02 = PSPDec(16 + classes, classes, 128, 112)
        self.p03 = PSPDec(16 + classes, classes, 96, 112)
        self.p04 = PSPDec(16 + classes, classes, 72, 112)
        ...
        self.p10 = PSPDec(classes + 256, 64, 80, 56)  # 96/ 192
        self.p20 = PSPDec(classes + 256, 64, 64, 56)
        self.p30 = PSPDec(classes + 256, 64, 48, 56)
        self.p40 = PSPDec(classes + 256, 64, 36, 56)
        ...
        self.p1 = PSPDec(512, 128, 40, 28)  # 96, 72
        self.p2 = PSPDec(512, 128, 32, 28)
        self.p3 = PSPDec(512, 128, 24, 28)
        self.p4 = PSPDec(512, 128, 18, 28)
...
class ResNetD1_YNet(nn.Module):
    ...
    def __init__(self, classes=1, diagClasses=3, segNetFile=None):
        super().__init__()
