...
class AttU_Net1(nn.Module):
    def __init__(self, img_ch=3, output_ch=1, diagClasses=3):
        ...
        self.fc2 = nn.Linear(128, diagClasses)
        ...
        self.Att2 = Attention_block(F_g=32, F_l=32, F_int=18)
